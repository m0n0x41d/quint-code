...
## Difference from /q3-research

| This Command (/q3-test) | /q3-research |
|----------------------------|-----------------|
...
|-----------|------|-----|---------|
| [...] | ... | ... | ... |
| [now] | DEDUCTION_COMPLETE | INDUCTION_COMPLETE | /q3-test |

## Next Step
- `/q3-research` for external evidence (optional, complements internal)
- `/q4-audit` for critical review before deciding (recommended)
- `/q5-decide` to finalize (if confident, audit recommended first)
```
...
**Next Step:**
- `/q3-research` — Gather external evidence (complements internal tests)
- `/q4-audit` — Critical review of all evidence (recommended)
- `/q5-decide` — Finalize decision (audit recommended first)
```
