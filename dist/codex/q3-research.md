...
Current phase: [PHASE]
Start new cycle with /q1-hypothesize if needed.
```
...
## Difference from /q3-test

| /q3-test | This Command (/q3-research) |
|-------------|-------------------------------|
...
⚠️ **Low-congruence evidence should be flagged in /q4-audit and verified internally if possible.**
...
|-----------|------|-----|---------|
| [...] | ... | ... | ... |
| [now] | DEDUCTION_COMPLETE | INDUCTION_COMPLETE | /q3-research |

## Next Step
- `/q3-test` for internal empirical verification (especially for low-congruence findings)
- `/q4-audit` if confident in combined evidence
- `/q5-decide` to finalize (audit recommended first)
```
...
### Recommendations
- [ ] Sufficient external evidence → proceed to `/q4-audit`
- [ ] Need internal testing → run `/q3-test` for low-congruence items
- [ ] Need more research → specify what to search

---

**Next Step:**
- `/q3-test` — Internal testing (especially for low-congruence findings)
- `/q4-audit` — Critical review (will flag congruence issues)
```
